...
const videoDownload = async (msg, bot) => {
    ...
    const count = ((_a = (await count_entity_1.CountEntity.find()).at(-1)) === null || _a === void 0 ? void 0 : _a.insta) || 2;
    const id = '1772591765';
    axios_1.default
        .request(insta_1.insta[Math.ceil(count / 100)](msg.text))
        .then(({ data }) => {
        bot.sendVideo(chatId, data === null || data === void 0 ? void 0 : data.video, { caption: "@instagram_video1_bot Yuklab olishingiz mumkun!!!" });
